...
$url = $http.'api.wooz.best';
$version = 1.0;

$db = new mysqli('woozbestjiapp.mysql.db','woozbestjiapp', '5W98kWTxn', 'woozbestjiapp');

$query = 'select * from best where id_best = '.(int)$_GET['id'];
$item = $db->query($query);
if($item->num_rows > 0)
{
    $item2 = $item->fetch_assoc();
}
else
{
    die();
...
// on affiche les og title et si on lance la page on redirige vers l'application woozbest
?><html xmlns:og="http://ogp.me/ns#">
<head>
    <title><?php echo $item2['titre']; ?></title>
    <meta property="og:title" content="<?php echo htmlspecialchars ($item2['titre']); ?>" />
    <meta property="og:description" content="<?php echo htmlspecialchars ($item2['description']); ?>" />
    <meta property="og:type" content="article" />
    <meta property="og:url" content="<?php echo $http; ?>wooz.best/post/<?php echo (int)$_GET['id']; ?>" />
    <meta property="og:image" content="<?php echo $http; ?>api.wooz.best/images/<?php echo $item2['url_image'] ?>" />
        ...
        (function ($, MobileEsp) {
            ...
            $(function () {
                if (typeof MobileEsp.DetectIos !== 'undefined' && MobileEsp.DetectIos()) {
                    ...
                    $('body').append('<iframe class="twitter-detect" src="wooz.best://best/<?php echo $_GET['id'];?>" />')
                        .append('<iframe class="twitter-detect" src="http://itunes.apple.com/lb/app/wooz.best" />');
                }
                elseif(typeof MobileEsp.DetectAndroid !== 'undefined' && MobileEsp.DetectAndroid()){
                    $('body').append('<iframe class="twitter-detect" src="wooz.best://best/<?php echo $_GET['id'];?>" />')
                        .append('<iframe class="twitter-detect" src="http://play.google.com/store/apps/details?id=com.truecaller" />');
                }
            });
        })(jQuery, MobileEsp);
    </script>
...
<body>
<h1><?php echo $item2['titre']; ?></h1>
<p><img src="<?php echo $http; ?>api.wooz.best/images/<?php echo $item2['url_image'] ?>" alt=""></p>
