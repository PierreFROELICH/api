...
CREATE TABLE `mot_cle` (
  ...
  `id_tag_fk` varchar(45) CHARACTER SET latin1 NOT NULL,
  `date_creation` datetime DEFAULT NULL,
  `date_modification` datetime DEFAULT NULL,
  PRIMARY KEY (`id_mot_cle`),
  KEY `mc_libelle_INDEX` (`libelle`),
  KEY `mc_tag_fk_index` (`id_tag_fk`)
...
INSERT INTO `mot_cle` VALUES (1,'ddd',1,'1','2018-02-02 00:00:00',NULL);
